...
class BattleAssets:
    prefix_path = "tasks/afkos/assets/battle/"
    ...
    T_SUCCESS = RecogText(
        keywords=["天赋挑战", "下一关", "多队挑战", "幻灵挑战", "下一层", "挑战"], black_list=["再次挑战", "自动挑战", "动挑战"], roi_area=[0, 640, 720, 640]
    )
    T_FAIL = RecogText(keywords=["再次挑战"], black_list=["天赋挑战", "挑战", "自动挑战", "动挑战"], roi_area=[391.0, 1155.0, 216.0, 118.0])

    T_FINISH_GOD = RecogText(keywords=["再次挑战"], black_list=["天赋挑战", "挑战", "自动挑战", "动挑战"], roi_area=[391.0, 1155.0, 216.0, 118.0])
    T_FAIL_GOD = RecogText(keywords=["点击空白处", "白处继续"], roi_area=[221.0, 1108.0, 279.0, 143.0])
